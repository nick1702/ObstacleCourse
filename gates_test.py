...
class TestGateLinkedList(unittest.TestCase):
    ...
    def test_insert_gate(self):
        gate1 = Gate(1, 100, 200, 45.0)
        gate2 = Gate(2, 150, 250, 90.0)
    ...
    def test_to_list(self):
        ...
        expected_list = [
            {"gate_id": 0, "x": 100, "z": 200, "rotation": 45.0},
            {"gate_id": 1, "x": 150, "z": 250, "rotation": 90.0}
        ]
